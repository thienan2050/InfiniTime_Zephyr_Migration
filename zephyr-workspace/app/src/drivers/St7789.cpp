...
void St7789::SoftwareReset() {
  ...
  sleepIn = true;
  //Replace by Zephyr OS: lastSleepExit = xTaskGetTickCount();
  //Replace by Zephyr OS: vTaskDelay(pdMS_TO_TICKS(125));
}
...
void St7789::SleepOut() {
  ...
  //Replace by Zephyr OS: vTaskDelay(pdMS_TO_TICKS(6));
...
void St7789::EnsureSleepOutPostDelay() {
  //Replace by Zephyr OS: TickType_t delta = xTaskGetTickCount() - lastSleepExit;
  ...
  //Replace by Zephyr OS: if (delta < pdMS_TO_TICKS(125)) {
  //Replace by Zephyr OS:   vTaskDelay(pdMS_TO_TICKS(125) - delta);
}
...
void St7789::HardwareReset() {
  ...
  //Replace by Zephyr OS: vTaskDelay(pdMS_TO_TICKS(1));
  nrf_gpio_pin_set(pinReset);
